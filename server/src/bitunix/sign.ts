// Bitunix REST request signing for Node (Web Crypto is a global since Node 20,
// so this is a verbatim port of the browser implementation in
// src/lib/bitunix/sign.ts and produces identical signatures).
//
